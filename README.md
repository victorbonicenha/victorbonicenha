<div align="center">
<img src="https://capsule-render.vercel.app/api?type=slice&color=0:0d1117,100:1A56B0&height=200&text=Victor%20Bonicenha&fontSize=48&fontColor=fff&desc=Python%20·%20RPA%20·%20Engenharia%20De%20Dados&descSize=18&descColor=a0b4cc&fontAlignY=40&descAlignY=60" width="100%"/>
</div>
...
[![Email](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:victorbonicenha05@gmail.com)
...
![Data Lake](https://img.shields.io/badge/Data_Lake-003366?style=for-the-badge&logo=delta&logoColor=white)
...
| [📊 databricks-sales-lakehouse](https://github.com/victorbonicenha/databricks-sales-lakehouse) | Pipeline Lakehouse de vendas com Databricks, PySpark e Delta Lake, usando arquitetura Bronze, Silver e Gold para ingestão, tratamento, validação e criação de métricas analíticas | `Databricks` `PySpark` `Delta Lake` `SQL` `Medallion` `ETL` |
